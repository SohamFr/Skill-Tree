          ...
          >
            <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0d0d0d] border border-[#DEDBC8]/10 rounded-3xl p-8 w-full max-w-md mx-auto mb-12 relative overflow-hidden shadow-2xl">
              ...
              <div className="flex items-start justify-between mb-8 relative z-10">
                <span className="font-mono text-[10px] text-[#DEDBC8]/30 tracking-widest">
                  SKILLTREE
                </span>
              ...
              <div className="flex items-center justify-between relative z-10">
                <div>
                  ...
                  <div className="text-[#E1E0CC] text-3xl font-bold font-mono">
                    {s?.activityScore ?? 0}
                  </div>
                </div>
                ...
                <div>
                  ...
                  {topLang ? (
                    <span className="bg-[#DEDBC8]/10 text-[#DEDBC8] text-xs px-3 py-1 rounded-full font-mono">
                      {topLang}
                    </span>
                  ) : (
