...
export const GitHubAnalyzer: React.FC = () => {
  ...
  return (
    <section
      id="analyzer"
      className="bg-black py-24 px-4 md:px-8 w-full relative overflow-hidden"
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <WordsPullUpMultiStyle
            segments={[
              {
                text: "Analyze any GitHub",
                className: "text-[#DEDBC8] font-normal",
              },
              {
                text: "profile instantly.",
                className: "font-serif italic text-[#DEDBC8] px-[0.05em]",
              },
            ]}
          ...
          >
              ...
              <div className="bg-[#101010] border border-white/5 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <div className="bg-black/50 rounded-xl p-3 text-center">
                    <div className="text-[#DEDBC8] font-mono text-lg">
              ...
              <div className="bg-[#101010] border border-white/5 rounded-2xl p-6 shadow-2xl">
                ...
                {languages.map((lang) => (
                  <div key={lang.name} className="flex items-center gap-3 mb-2">
                    <span className="text-gray-400 text-xs w-20 font-mono">
                      {lang.name}
                    </span>
            ...
            >
              ...
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-7xl font-bold text-[#E1E0CC]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  { label: "Contribution", value: Math.round(avgComplexity * 0.85) },
                  {
                    label: "Diversity",
                    value: Math.round(
                      avgComplexity * (data.repositories.length > 5 ? 0.95 : 0.6)
                    ),
                  },
                  { label: "Recency", value: Math.round(avgComplexity * 0.75) },
                ].map((s) => (
                  <div key={s.label} className="text-center">
                    <div className="text-[#E1E0CC] text-lg font-mono font-bold">
                      {s.value}
                    </div>
